# RwPay OpenAPI Specification
[![Build Status](https://travis-ci.org/richard457/rwpay.svg?branch=master)](https://travis-ci.org/richard457/rwpay)
...
6. If you did everything correct, https://richard457.github.io/rwpay/ will lead to your new docs
...
- Documentation(ReDoc): https://richard457.github.io/rwpay/
- SwaggerUI: https://richard457.github.io/rwpay/swagger-ui/
- Look full spec:
    + JSON https://richard457.github.io/rwpay/swagger.json
    + YAML https://richard457.github.io/rwpay/swagger.yaml
- Preview spec version for branch `[branch]`: https://richard457.github.io/rwpay/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://richard457.github.io/rwpay/ with url from the message: `Server started <url>`
